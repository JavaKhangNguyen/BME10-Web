...
const CIcon = (props) => {
  ...
  //render
  const computedClasses = classNames('c-icon', computedSize && `c-icon-${computedSize}`, className)
  ...
  return (
    <React.Fragment>
      ...
      {!src && use && (
        <svg {...attributes} xmlns="http://www.w3.org/2000/svg" className={classes} role="img">
          <use href={use}></use>
        </svg>
      )}
    </React.Fragment>
